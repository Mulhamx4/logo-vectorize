...
export function mount(root: HTMLElement, opts?: { lang?: 'ar' | 'en'; hostActionLabel?: string; onUse?: (p: UsePayload) => void; onResult?: (r: TraceResult) => void; persist?: boolean }): { setLang(l: 'ar' | 'en'): void; destroy(): void };
